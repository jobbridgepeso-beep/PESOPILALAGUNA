...
export default function PendingVacancyList() {
  ...
  const approveMut = useMutation({
    ...
    onSuccess: (res) => {
      if (res.success) {
        ...
        qc.invalidateQueries({ queryKey: ['staff-vacancies'] })
  ...
  if (isLoading) {
    return <p className="text-sm text-muted-foreground">Loading pending vacancies…</p>
  }
